...
ax[0][0].plot(rx_nothreads_norm.real[0:800])
ax[0][0].set_title(r"$\Re$ part before matched filter")

ax[0][1].plot(rx_nothreads_norm.imag[0:800])
ax[0][1].set_title(r"$\Im$ part before matched filter")

rx_nothreads_norm_matched = np.convolve(rx_nothreads_norm, np.ones(10))


ax[1][0].plot(rx_nothreads_norm_matched.real[0:800], "g")
ax[1][0].set_title(r"$\Re$ part after matched filter")

ax[1][1].plot(rx_nothreads_norm_matched.imag[0:800], "g")
